...
namespace Grower
{
    public class HeadMover : MonoBehaviour
    {
        ...
        {
                if (Input.GetKey(KeyCode.W)) SetDirection(Vector3.forward);
                else if (Input.GetKey(KeyCode.S)) SetDirection(Vector3.back);
                else if (Input.GetKey(KeyCode.A)) SetDirection(Vector3.left);
                else if (Input.GetKey(KeyCode.D)) SetDirection(Vector3.right);
        }
