...
namespace Grower
{
    ...
    public class HeadMover : MonoBehaviour
    {
        ...
        public bool IsMoving => isMoving; // Свойство для проверки, двигается ли объект
        ...
        private void Awake()
        {
            ...
            if (mainCamera == null) mainCamera = Camera.main; // Получаем ссылку на камеру, если не указана
        }
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            {
                StopMovement();
                // Триггерим импульс камеры при столкновении с объектом
                if (cameraImpulse != null)
                {
                    cameraImpulse.TriggerImpulse(collision.contacts[0].normal);
                }
            }
        }
